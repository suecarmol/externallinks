...
class PageAggregate(models.Model):
    class Meta:
        app_label = "aggregates"
    ...
    def validate_unique(self, *args, **kwargs):
        ...
        if self.__class__.objects.filter(
            ...
            raise ValidationError(
                message="PageAggregate with this combination (organisation, collection, page_name, full_date) already exists.",
                code="unique_together",
            )
...
class ProjectAggregate(models.Model):
    ...
    def validate_unique(self, *args, **kwargs):
        ...
        if self.__class__.objects.filter(
            ...
            raise ValidationError(
                message="ProjectAggregate with this combination (organisation, collection, project_name, full_date) already exists.",
                code="unique_together",
            )
